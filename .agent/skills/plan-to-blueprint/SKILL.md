...
description: 새로운 기능/아키텍처 기획 문서를 작성하고, 블루프린트에 관점별 작업 항목으로 등록하는 표준 스킬입니다.
---
...
| **관점 배분** | 각 Phase마다 담당 관점과 권장 모델 명시 |
