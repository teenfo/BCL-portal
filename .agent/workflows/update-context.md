...
| 단계 | 관점 | 권장 모델 | 핵심 역할 |
|:-----|:-----|:---------|:---------:|
| 1. 작업 내용 분석 | 💻 **Developer** | Claude Sonnet 4.6 | 변경 사항 요약, 누락 확인 |
| 2. 블루프린트 갱신 | 💻 **Developer** | Claude Sonnet 4.6 | Active Context 업데이트 |
| 3. 체크리스트 동기화 | 💻 **Developer** | Claude Sonnet 4.6 | Phase 체크박스 업데이트 |
| 4. 최종 확인 | 🏛️ **Architect** | Gemini 3 Pro (High) | 컨텍스트 완전성 검토, 커밋 승인 |
...
- [ ] Next Steps 작성 완료 (담당 관점 명시)
- [ ] 기본 기능 영향 사항 기록 완료

### 🏛️ Architect 관점 (권장: Gemini Pro High)
- [ ] 컨텍스트 완전성 검토 완료
- [ ] Next Steps 관점 배분 적절성 확인
- [ ] 커밋 승인 완료
