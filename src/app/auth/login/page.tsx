                    ...
                    <div style={{
                        ...
                        <button
                            ...
                            onClick={async () => {
                                ...
                                const { error: oauthError } = await signInWithOAuth('kakao');
                                if (oauthError) {
                            ...
                            style={{
                                ...
                                justifyContent: 'center',
                                gap: 10,
                                opacity: (submitting || oauthLoading) ? 0.6 : 1,
                            }}
                            onMouseEnter={(e) => {
                                if (!submitting && !oauthLoading) {
                                    e.currentTarget.style.transform = 'translateY(-1px)';
                        ...
                        >
                            {oauthLoading ? (
                                <>
                                    <svg style={{ animation: 'spin 1s linear infinite' }} width={18} height={18} viewBox="0 0 24 24" fill="none">
                                        <circle cx="12" cy="12" r="10" stroke="rgba(25,25,25,0.3)" strokeWidth="3" />
                                        <path d="M12 2a10 10 0 019.7 7.5" stroke="#191919" strokeWidth="3" strokeLinecap="round" />
                                    </svg>
                                    카카오 로그인 중...
                                </>
                            ) : (
