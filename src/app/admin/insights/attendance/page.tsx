        ...
        <div className="p-8 lg:p-12">
            ...
            <header className="flex items-end justify-between mb-12">
                <div>
                    ...
                    <h1 className="text-4xl font-black text-white uppercase">Attendance <span className="opacity-20 font-light ml-2">Report</span></h1>
                </div>
            ...
            {loading ? (
                ...
                <div className="space-y-10">
                    ...
                    <div className="glass-card p-8">
                        <h3 className="text-xl font-black text-white uppercase tracking-tight mb-8">📈 Daily Attendance Trend</h3>
                    ...
                    <div className="grid grid-cols-12 gap-8">
                        ...
                        <div className="col-span-8 glass-card p-8">
                            <h3 className="text-xl font-black text-white uppercase tracking-tight mb-8">🕐 Hourly Distribution</h3>
                        ...
                        <div className="col-span-4 glass-card p-8">
                            <h3 className="text-lg font-black text-white uppercase tracking-tight mb-8">📱 Check-in Methods</h3>
