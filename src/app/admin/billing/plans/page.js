    ...
    return (
        <div className="animate-fade-in">
            <header style={{ marginBottom: "32px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div>
                    <h1 style={{ fontSize: "1.75rem", marginBottom: "8px" }}>멤버십 플랜 관리</h1>
                    <p style={{ color: "var(--text-secondary)" }}>센터에서 운영하는 멤버십 상품을 관리합니다.</p>
                </div>
                <button onClick={() => setIsModalOpen(true)} className="btn-primary">+ 새 플랜 추가</button>
            </header>
