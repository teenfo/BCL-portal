...
import {
    IconSmartphone, IconMonitor, IconHand, IconFaceId,
    IconRadio, IconSettings, IconMembers, IconCalendar,
    IconMegaphone, IconCreditCard, IconDollar
...
export default function AdminDashboardPage() {
    ...
    const methodIcons: Record<string, React.ReactNode> = {
        qr: <IconSmartphone size={14} />,
        kiosk: <IconMonitor size={14} />,
        manual: <IconHand size={14} />,
        face: <IconFaceId size={14} />,
    };
                                                ...
                                                <div key={c.id} className="p-4 rounded-xl bg-white/[0.02] border border-white/[0.03] hover:border-white/10 transition-all group flex gap-4">
                                                    ...
                                                    <div className="flex-1">
                                                        <div className="flex items-center justify-between mb-1">
                                                            <span className="text-[8px] font-black uppercase tracking-widest text-green-400 flex items-center gap-1">
                                                                {methodIcons[c.checkin_method] || <IconRadio size={12} />} {c.checkin_method}
                                                            </span>
