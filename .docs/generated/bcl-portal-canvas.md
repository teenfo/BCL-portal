# BCL Portal Canvas Export (Snapshot)

> Source: Current Canvas content (BCL Portal Sitemap v0.5 + Appendices)
...
# 부록 A) Supabase 테이블 도출 (Sitemap v0.5 기준)
...
# 부록 C) User UX (Bottom Tab 규칙)
- Home: dashboard
- Schedule: schedule/session
- Check-in: qr/status/history
- Facilities: list/detail
- Profile: profile/settings

---

# 부록 D) Admin → User 데이터 흐름
