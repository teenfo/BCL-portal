...
### 3. 운영 및 개발 환경
- **[서버 배포 가이드 (Deployment)](file:///Users/kimchoho/Develop/Antigravity/BCL-Repo/portal/.docs/deployment-ubuntu.md)**: 우분투 도커 서버 배포 및 자동화(`deploy.sh`) 가이드
- **[설치 및 설정 (Setup)](file:///Users/kimchoho/Develop/Antigravity/BCL-Repo/portal/.docs/deployment.md)**: 초기 환경 설정 및 로컬 개발 가이드
